            ...
            <div className="container mx-auto max-w-7xl">
                ...
                <div className="flex items-start justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600">Gestiona y monitorea tus publicaciones.</p>
                    </div>
                    <Button
                ...
                <div className="bg-white p-6 rounded-xl border border-gray-100">
                    ...
                    {announcements.length === 0 ? (
                        <div className="text-center py-12">
                            <p className="text-gray-500 mb-4">No tienes anuncios publicados</p>
                            <Button
                                style={{ backgroundColor: "var(--roomlock-cta)", color: "white" }}
                                onClick={() => toast.info('Función próximamente')}
                            >
                        ...
                        <div className="space-y-4">
                            {announcements.map((announcement) => (
                                <div
                                    key={announcement.id}
                                    className="flex flex-col sm:flex-row gap-4 p-4 border border-gray-200 rounded-xl hover:shadow-md transition-shadow"
                                >
                                    {/* Image */}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                                            <div className="flex-1 min-w-0">
                                                <h3 className="text-lg font-semibold mb-1 truncate" style={{ color: "var(--roomlock-text-primary)" }}>
                                                    {announcement.title}
                                                </h3>
                                            ...
                                            <span
                                                className={`px-3 py-1 rounded-full text-sm font-medium whitespace-nowrap ${announcement.state === 'activo'
                                        ...
                                        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-3">
                                            ...
                                            <div className="font-medium" style={{ color: "var(--roomlock-primary)" }}>
